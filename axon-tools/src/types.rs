...
pub struct ExtraData {
    #[cfg_attr(
        feature = "impl-serde",
        serde(serialize_with = "withpfx_lowercase::serialize", deserialize_with = "withpfx_lowercase::deserialize")
    )]
    pub inner: Bytes,
}
...
pub struct AxonHeader {
    ...
    #[cfg_attr(
        feature = "impl-serde",
        serde(serialize_with = "encode::serialize_uint", deserialize_with = "decode::deserialize_hex_u64")
    )]
    pub timestamp:                u64,
    #[cfg_attr(
        feature = "impl-serde",
    ...
    #[cfg_attr(
        feature = "impl-serde",
        serde(serialize_with = "encode::serialize_uint", deserialize_with = "decode::deserialize_hex_u32")
    )]
